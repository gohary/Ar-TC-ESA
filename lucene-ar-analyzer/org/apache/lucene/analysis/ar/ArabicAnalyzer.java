 ...
 * <p>
 * This analyzer implements light-stemming as specified by: <i> Light Stemming
 * for Arabic Information Retrieval </i>
...
public final class ArabicAnalyzer extends Analyzer {
	 ...
	 * http://members.unine.ch/jacques.savoy/clef/index.html The stopword list
	 * is BSD-Licensed.
	 */
	...
	private static class DefaultSetHolder {
		...
		static Set<String> loadDefaultStopWordSet() throws IOException {
			...
			try {
				...
				// class
				return Collections.unmodifiableSet(WordlistLoader.getWordSet(
						reader, STOPWORDS_COMMENT));
			} finally {
				stream.close();
			}
		}
	 ...
	 * 
	 * @return A {@link TokenStream} built from an {@link ArabicLetterTokenizer}
	 *         filtered with {@link LowerCaseFilter}, {@link StopFilter},
	 *         {@link ArabicNormalizationFilter} and {@link ArabicStemFilter}.
	 */
	@Override
